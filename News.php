      ...
      <div id="page-in" class="box">
        ...
        <div id="content">
          ...
          <div class="articless">
            ...
            <div class="subart"><div class="upper">Those are news of the company posted by the Adminstrator.</div>
            <div class="lower" id="lower">The news includes about online services that can employers and job seeker particpate </div>
