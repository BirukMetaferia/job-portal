    ...
    <div id="page-in" class="box">
        ...
        <div id="content">
            ...
            <div class="article">
                    ...
                    <div class="loginj">
					<h2 class="titlefor">Job Seeker Registration Form</h2>
					<img id="pic" class="size" alt="person profile"  src="design/ppp.jpg">
                <form action="JobSeekerInsert.php" method="post" onSubmit="return validateForm(this,arrFormValidation);" enctype="multipart/form-data" id="form2">
                     ...
                     JobSeeker Name:
                      ...
                      <span class="textfieldRequiredMsg">Enter Name</span></span>
                   ...
                   Address:
                      ...
                      <span class="textfieldRequiredMsg">Enter Email Id</span></span>
					  ...
					  <span class="textfieldRequiredMsg">Enter Qualification</span>
                   
                      Other:
                      <label class="emregl">
                        <input type="text" name="txtOther" id="txtOther" />
                      </label>
					  Gender:<label class="emregl">
                      ...
                      <span class="textfieldRequiredMsg">Enter Birth Date</span></span>
					  Upload Marksheet:<label class="emregl">
					  ...
					  Password:<label class="emregl"><span id="sprytextfield9">
                        <input type="password" name="txtPassword" id="txtPassword" />
                      <span class="textfieldRequiredMsg">Enter Password</span></span></label>
					  Security Question:<label class="emregl">
					  ...
					  Answer:<span id="sprytextfield10">
                        <label class="emregl">
                        <input type="text" name="txtAnswer" id="txtAnswer" />
                        </label>
                      <span class="textfieldRequiredMsg">Enter Answer.</span></span><label class="emregl">
                        <label class="emregl"></label>
                        <div align="center">
